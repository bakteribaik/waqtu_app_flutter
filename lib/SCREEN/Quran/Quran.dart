...
class _QuranPagesState extends State<QuranPages> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: isFetch ? Text(data.data![quranNumber].name!.transliteration!.id.toString(), style: TextStyle(color: Colors.green[300], fontWeight: FontWeight.bold, fontSize: 15),) : Text('Loading..', style: TextStyle(color: Colors.green[300], fontWeight: FontWeight.bold, fontSize: 15),),
        actions: [
          isFetch ?
          GestureDetector(
            onTap: (){
                          ...
                          Container(
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  Text('Surah ${data.data![quranNumber].name!.transliteration!.id} atau yang memiliki arti ${data.data![quranNumber].name!.translation!.id}, terdiri dari ${data.data![quranNumber].numberOfVerses} ayat dan tergolong surah ${data.data![quranNumber].revelation!.id}'),
                                  SizedBox(height: 10,),
                                  Text('Tafsir Surah', style: TextStyle(fontWeight: FontWeight.bold),),
                                  Text('${data.data![quranNumber].tafsirSurah!.id}'),
                                  SizedBox(height: 10,),
            ...
            child: Container(
              ...
              child: Container(
                ...
                child: Center(child: Text('info surah', style: TextStyle(fontSize: 11,color: Colors.lightBlue[300]),)),
              ),
            ),
          ) : SizedBox()
        ],
  ...
  _searching(String input){
    result = data.data![quranNumber].verses!.where((element) => element.number!.inSurah.toString() == input).toList();
  }
