              ...
              children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(data.data![quranNumber].verses![numberInSurah].text!.arab.toString(), style: TextStyle(fontSize: 25, fontFamily: 'Misbah', height: 2), textAlign: TextAlign.right,)
                      ),
                    ],
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Tafsir Pendek', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),),
                      Text(data.data![quranNumber].verses![numberInSurah].tafsir!.id!.short.toString(), textAlign: TextAlign.justify, style: TextStyle(color: Colors.grey[600]),),
                    ],
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Tafsir Panjang', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      Text(data.data![quranNumber].verses![numberInSurah].tafsir!.id!.long.toString(), textAlign: TextAlign.justify, style: TextStyle(color: Colors.grey[600]),),
                    ],
                  ),
                ),
                Divider(),
                SizedBox(height: 10,),
                Text('Sumber: sutanlab Api x Kemenag', style: TextStyle(color: Colors.grey[600], fontSize: 11),),
                SizedBox(height: 20,),
              ],
            ),
          ),
